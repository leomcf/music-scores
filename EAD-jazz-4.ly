...
analysisLine = {
  ...
  \once \override Score.RehearsalMark.extra-offset = #'(-7 . -1)  % Adjust left to center properly
  \once \override Score.RehearsalMark.direction = #DOWN
  \once \override Score.RehearsalMark.padding = #5  % Increased space between staff and line
