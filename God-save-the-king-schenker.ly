...
% Create empty staves for analysis - keeping the staves visible but empty
emptyStaff = {
...
righthand = \relative c'' {
  ...
  \tuplet 3/2 {a8 g f} <g c e>4 <f b d> |
  <e g c>4 r r
}
...
\score {
  \new StaffGroup <<
    ...
    \new PianoStaff \with {
      ...
      \new Staff = "empty2" { \clef bass \emptyStaff }
    >>
    ...
    \new PianoStaff \with {
      ...
      \new Staff = "empty4" { \clef bass \emptyStaff }
    >>
    ...
    \new PianoStaff \with {
      ...
      \new Staff = "empty6" { \clef bass \emptyStaff }
    >>
    ...
    \new PianoStaff \with {
      ...
      \new Staff = "empty8" { \clef bass \emptyStaff }
    >>
